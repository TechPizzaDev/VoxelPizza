...
namespace VoxelPizza.Client
{
    ...
    public class ConstructedMesh16 : ConstructedMesh
    {
        ...
        {
            DeviceBuffer ib = factory.CreateBuffer(new BufferDescription(Indices.SizeInBytes(), BufferUsage.IndexBuffer));
            cl.UpdateBuffer(ib, 0, Indices);
            return ib;
        }

        public bool RayCast(Ray ray, bool any, out float distance)
        {
