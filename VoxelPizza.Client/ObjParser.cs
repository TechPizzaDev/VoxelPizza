    ...
    public class ObjParser
    {
        ...
        private class ParseContext
        {
            ...
            public void Process(ReadOnlySpan<char> line)
            {
                ...
                var splitter = new ReadOnlySpanSplitter<char>(line, _whitespaceChar, StringSplitOptions.RemoveEmptyEntries);
                ...
                {
                    ExpectPieces(ref splitter, "v", true, out var piece1, out var piece2, out var piece3);
                    DiscoverPosition(ParseVector3(piece1, piece2, piece3, "position data"));
                }
                else if (piece0.SequenceEqual("vn"))
                {
                    ExpectPieces(ref splitter, "vn", true, out var piece1, out var piece2, out var piece3);
                ...
                {
                    ExpectPieces(ref splitter, "g", false, out var piece1);
                    FinalizeGroup();
                    _currentGroupName = piece1.ToString();
                }
                else if (piece0.SequenceEqual("usemtl"))
                {
                    ExpectPieces(ref splitter, "usematl", true, out var piece1);
                ...
                {
                    ExpectPieces(ref splitter, "s", true, out var piece1);
                ...
                {
                    ExpectPieces(ref splitter, "f", false, out var piece1, out var piece2);
                    ProcessFaceLine(ref splitter, piece1, piece2);
                }
                else if (piece0.SequenceEqual("mtllib"))
                {
                    ExpectPieces(ref splitter, "mtllib", true, out var piece1);
