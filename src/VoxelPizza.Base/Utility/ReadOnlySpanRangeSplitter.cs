...
{
    public ref struct ReadOnlySpanRangeSplitter<T>
        where T : IEquatable<T>
    {
        ...
        public ReadOnlySpan<T> CurrentSpan => Value[Current];

        public ReadOnlySpanRangeSplitter(
        ...
        public ReadOnlySpanRangeSplitter<T> GetEnumerator()
        {
            return this;
        }
    }
